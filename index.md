...
description: "A public documentation portal documenting New Jersey cases, faith reflections, and public-trust issues at the intersection of law, conscience, and civic integrity."
---

<section class="hero" aria-label="Welcome and introduction">
  <div class="hero-inner">
    <p class="hero-kicker">Faith Frontier Ecclesiastical Trust</p>
    <h1>Turning lived injustice into public record.</h1>
    <p class="hero-lead">
      A transparent public archive at the intersection of <strong>law, faith, and civic integrity</strong>—documenting New Jersey cases, wage and benefits disputes, prolonged detention, and the systems that shape them.
    </p>
    <div class="hero-actions">
      <a class="btn-primary" href="{{ '/cases/' | relative_url }}" aria-label="Browse active case records and dockets">Browse Active Cases</a>
      <a class="btn-ghost" href="{{ '/faith/' | relative_url }}" aria-label="Read faith reflections and essays">Read Faith Reflections</a>
    </div>
    <p class="hero-footnote">
      Built by a New Jersey tradesman and pro se litigant who spent <strong>108 days in custody before seeing a judge</strong>, fought wage theft and benefits denials, and now publishes the paper trail for public accountability.
    </p>
  </div>
</section>

<section class="features" aria-label="Main features and resources">
  <div class="feature-grid">

    <article class="feature-card">
      <h2>Case Engine: Courts, Wage Claims, and Appeals</h2>
      <p>
      ...
      <a class="card-link" href="{{ '/cases/' | relative_url }}">View Case Summaries and Documents</a>
        ...
        <article class="feature-card">
      <h2>Faith, Doctrine and Formation Under Pressure</h2>
      <p>
      ...
      <a class="card-link" href="{{ '/faith/' | relative_url }}">Read Essays and Faith Notes </a>
        ...
        <article class="feature-card">
      <h2>Public Trust and Systems Integrity</h2>
      <p>
...
<section class="mission" aria-label="Mission statement">
...
<section class="how-it-works" aria-label="How to use this site">
  <h2>How to Use This Site</h2>
  <div class="how-grid">
    <article class="how-step">
      <h3>1. Start with a Case</h3>
      <p>
        Visit the <a href="{{ '/cases/' | relative_url }}">Cases index</a> and choose a matter—for example, <strong>NJTA v. Barber</strong> or a Special Civil Part dispute.
    ...
    <article class="how-step">
      <h3>3. Connect Law, Policy and Faith</h3>
      <p>
